...
# Optional PyTorch imports with error handling
try:
    import torch
    ...
    print("Warning: PyTorch not available. TextCNN features will be disabled.")
    TORCH_AVAILABLE = False
    torch = None
    nn = None
    F = None

# Additional PyTorch imports
if TORCH_AVAILABLE:
...
class TextCNNSentimentAnalysis:
    def __init__(self):
        if not TORCH_AVAILABLE:
            raise ImportError("PyTorch is required for TextCNNSentimentAnalysis. Please install: pip install torch")
        # 加载停用词

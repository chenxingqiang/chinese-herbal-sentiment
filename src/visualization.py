...
# 设置阿里巴巴字体
alibaba_font_path = setup_alibaba_font()
...
def generate_wordcloud_visualization():
    """生成词云图"""
    print("生成词云图...")
    ...
    try:
        ...
        if alibaba_font_path:
            wc_params['font_path'] = alibaba_font_path
            print(f"正面词云使用字体: {alibaba_font_path}")
    ...
    try:
        ...
        if alibaba_font_path:
            wc_params['font_path'] = alibaba_font_path
            print(f"负面词云使用字体: {alibaba_font_path}")
...
def main():
    ...
    generate_wordcloud_visualization()
    ...
    print(f"使用的字体: {alibaba_font_path if alibaba_font_path else '系统默认字体'}")
